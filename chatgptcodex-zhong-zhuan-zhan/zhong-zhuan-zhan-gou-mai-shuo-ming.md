...
目前共有两种方案。购买时请先选择方案，再选择该方案中的额度档位；方案一可选 30 天或 90 天，方案二固定为 30 天。两种方案的主要区别不是总额度大小，而是额度能否集中使用。

| 方案 | 额度限制方式 | 适合的使用节奏 | 可选有效期 |
| --- | --- | --- | --- |
| 方案一 | 同时限制最近 3 小时额度和每日额度 | 使用可以分散到一天内 | 30 天或 90 天 |
| 方案二 | 仅限制周额度和 30 天总额度 | 需要集中完成连续任务 | 30 天 |

两种方案采用不同的额度统计方式，表中的数字不能直接互相换算。下表额度均为第三方平台内部计费单位。

## 方案一：最近 3 小时额度与每日额度

本方案适合把使用分散到一天内。短时间集中使用时，即使每日额度还有剩余，也可能先触发最近 3 小时限额。
