...
* Perform web searches when needed using

***

_Note: The original source page continues with additional language tabs (Kotlin, C#, Ruby) that were not available in the fetched content. This translation covers the Python, TypeScript, and partial Java sections._

_Source:_ [_Build an MCP client - Model Context Protocol_](https://modelcontextprotocol.io/docs/develop/build-client#building-mcp-clients)
